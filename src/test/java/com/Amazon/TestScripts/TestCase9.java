...
public class TestCase9 {
	...
	public void TC9() throws IOException
	{
		...
		homepageObj.VerifyComputersAndAccessoriesFromDropdown();
		}catch(Exception i)
		{
		...
		Assert.assertEquals(Value, "Computers & Accessories");
		System.out.println("Validated dropdown value is same as after clicking on specified item" );
	}
