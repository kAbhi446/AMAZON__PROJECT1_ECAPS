...
public class TestCase1 {
	...
	public void launch()
	{
		test = extentObj.startTest("Dropdown defalut value verification", extent);
	...
	{ 
		...
		homepageObj.defaultValueOfDropdown();
		}catch(Exception i)
		{
			Action.takeScreenshotAtEndOfTest();
		}
		test.log(LogStatus.PASS, "Verified default value");
		String value = homepageObj.dropdownValue.getText();
		Assert.assertEquals(value, "All");
		System.out.println("Verified default value of dropdown");
	}
